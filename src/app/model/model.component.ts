...
export class ModelComponent implements OnInit {
  ...
  thirdStepOfCalculation(  oneCount: Clasificator[] | null | undefined){
    ...
    oneCount?.forEach((count, index) => {
      ...
      switch (count.id) {
        case i:
            if (count.typeOfClasificatore === true){
            ...
            }else if(count.typeOfClasificatore === false){
              if(count?.secondStepCalc){
                let min
                for (let j = 0; j < count.secondStepCalc.length; j++) {
                  min = Math.min(count.secondStepCalc[j])
                }
      ...
      if(count.id === 0){
        emptyArr = count.secondStepCalc
      }else if(count.id === 1){
          emptyArr2 = count.secondStepCalc
      }else if(count.id === 2){
          emptyArr3 = count.secondStepCalc
      }else if(count.id === 3){
          emptyArr4 = count.secondStepCalc
      }else if(count.id === 4){
          emptyArr5 = count.secondStepCalc
      }else if(count.id === 5){
          emptyArr6 = count.secondStepCalc
      }else if(count.id === 6){
          emptyArr7 = count.secondStepCalc
      }else if(count.id === 7){
          emptyArr8 = count.secondStepCalc
      }else if(count.id === 8){
          emptyArr9 = count.secondStepCalc
      }else if(count.id === 9){
          emptyArr10 = count.secondStepCalc
      }
    })
  ...
  fourthStepOfCalculation(
    ...
    oneCount?.map((value) => {
      if(value.id === 0){
        if(value?.thirdStepCalc !== null || undefined) {
    ...
    this.fourthCount = [
      ...
      +Math.pow((Math.pow(emptyArr[23] - z1, 2) + Math.pow(emptyArr2[23] - z2 , 2) + Math.pow(emptyArr3[23] - z3 , 2) + Math.pow(emptyArr4[23] - z4 , 2) + Math.pow(emptyArr5[23] - z5 , 2) + Math.pow(emptyArr6[23] - z6 , 2) + Math.pow(emptyArr7[23] - z7 , 2) + Math.pow(emptyArr8[23] - z8 , 2) + Math.pow(emptyArr9[23] - z9 , 2) + Math.pow(emptyArr10[23] - z10, 2)) , 0.5)
    ]
    this.fifthStepOfCalculation(this.fourthCount);

    this.fourthCount.forEach( (value) => {
    ...
    for (let i = 0; i < fourtCount.length ; i++) {
      ...
      if(this.yy){
        ...
        if(this.iterdFourCount){
          ...
          this.k = 1 - this.di
        const newObject =  Object.assign({ numberOfKi: this.k} , this.emptyObject )
          this.arrOfKi.push(newObject)
        }
      }
    }
  }
